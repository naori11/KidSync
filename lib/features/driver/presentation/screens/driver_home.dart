...
import '../../../../screens/driver/driver_dashboard_tab.dart';
import '../../../../screens/driver/driver_pickup_tab.dart';
import '../../../../screens/driver/driver_students_tab.dart';
import '../../../../screens/driver/driver_recent_activity.dart';
...
class DriverHomeScreen extends ConsumerWidget {
  ...
  Future<void> _logout(BuildContext context, WidgetRef ref) async {
    final driverAuditService = DriverAuditService();
    try {
      ...
      if (user != null) {
        try {
          await driverAuditService.logDriverAuthActivity(
            activity: 'logout',
            driverId: user.id,
          ...
          debugPrint('Error logging logout activity: $auditError');
        }
      }
      ...
      if (user != null) {
        try {
          ...
          debugPrint('Error logging logout failure: $auditError');
        }
      }
...
class _DriverHomeTabs extends ConsumerStatefulWidget {
  final List<_NavItem> navItems;
  ...
  @override
  ConsumerState<_DriverHomeTabs> createState() => _DriverHomeTabsState();
}

class _DriverHomeTabsState extends ConsumerState<_DriverHomeTabs> {
  int selectedIndex = 0;
  ...
  Future<void> _initializeNotifications() async {
    try {
      ...
      debugPrint('✅ Notifications initialized for driver');
    } catch (e) {
  ...
  Future<String?> _getDriverProfileImage() async {
    try {
      ...
      return driverInfo?['profile_image_url'];
    } catch (e) {
      debugPrint('Error getting driver profile image: $e');
      return null;
    }
  }
  ...
  Future<void> _logDashboardAccess() async {
    try {
      ...
      debugPrint('Error logging dashboard access: $auditError');
    }
  }
