...
class DriverTheme {
  ...
  static BorderRadius dialogBorderRadius() => BorderRadius.circular(12);
  ...
  static TextStyle bodyTextStyle(bool isMobile) =>
      TextStyle(fontSize: isMobile ? 14 : 16, color: black);

  static TextStyle captionTextStyle(bool isMobile) =>
      TextStyle(fontSize: isMobile ? 12 : 14, color: black.withOpacity(0.7));
}
